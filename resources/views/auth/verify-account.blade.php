                ...
                <form action="/verify-otp" method="post">
                    ...
                    <div class="px-2 md:px-4 xl:pl-12 mt-4 mx-2 ">
                        <div class="lg:pt-16 mx-auto w-12/12 text-center">
                            <h1 class="text-center md:text-left  text-custom-dark-600 text-auto md:text-3xl lg:text-xl xl:text-3xl font-lora font-bold">OTP <span class="text-white"> VERIFICATION</span></h1>
                            <p class="text-center md:text-left text-custom-dark-500 text-sm md:text-default lg:text-sm xl:text-default" >Verify your account to get activated</p>
                            
                        </div>

                        <div class="bg-custom-green mt-7 rounded-md w-11/12"> 
                          <p class="px-4 py-2 text-custom-dark-green font-roboto w-full font-bold text-sm p-2">We’ve sent a verification code to 
                            your email - {{ session('email') }}</p>
